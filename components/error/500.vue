<template>
  <div class="error-500 container__full">
    <div class="text">
      <p>500</p>
      <span>
        Oppps... não se preocupe, nosso site está em versão beta e ainda estamos em construção. Isso não é desculpa para não continuar navegando,
        <n-link to="/blog">clique aqui e continue</n-link>.
      </span>
    </div>
    <div class="cont">
      <div class="caveman">
